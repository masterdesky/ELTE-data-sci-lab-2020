# Paramaters to set up the aspect, extent and resolution of the map
N = 2**10        # Number of pixels in the longer linear dimension. Since
                 # we are using lots of FFTs this should be a factor of 2^N.
